...
namespace UITemplate
{
    public class StartOptions : MonoBehaviour
    {
        ...
        public enum stateMenu { Main, Options }
        [SerializeField]
        ...
        void Awake()
        {
            ...
            selectEvent = GetComponent<ChangeSelectedEvent>();
        }
        ...
        public void OptionsUpdate()
        {
            if (Input.GetKeyDown(KeyCode.Escape))
            {
                ...
                selectEvent.ChangeSelect("PreSelect");
            }
        }
        ...
        public void ChangeState(string newState)
        {
            try
            {
                state = (stateMenu)Enum.Parse(typeof(stateMenu), newState);
            }
            catch (ArgumentException)
            {
                Debug.LogError("The state doesn't exist");
            }
        }
